...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/testflo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7765&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/testflo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `testflo` can be installed with:

```
conda install testflo
```

It is possible to list all of the versions of `testflo` available on your platform with:
